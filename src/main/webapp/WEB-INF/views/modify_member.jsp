...
<head>
	...
	<script>
		...
		$(function() {
	        ...
	        $(".email_input, .name_input, .address_input, .phone_input").click(function() {
	            toggleSubmitButton();
	        });
	        // 버튼 비활성화/활성화 기능
...
<body>
	...
	<div class="main_area">
		...
		<div class="main_content">
				<b>이메일</b>
				<input value="${sessionScope.loginMemberEmail}" class="email_input" type="text" name="email" placeholder="이메일 입력"/>
				<b>이름</b>
				<input value="${sessionScope.loginMemberName}" class="name_input" type="text" name="name" placeholder="이름 입력"/>
