	...
	<div class="main_top">
		...
		<div class="main_top_right">
			...
			<svg class="cart_logo" xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 20 20" fill="none" class="size-7">
				<path d="M4.3 16.5C4.13431 16.5 4 16.3657 4 16.2V7.8C4 7.63431 4.13432 7.5 4.3 7.5H15.7C15.8657 7.5 16 7.63431 16 7.8V16.2C16 16.3657 15.8657 16.5 15.7 16.5H4.3Z" stroke-width="1.4" stroke="#FFFFFF" vector-effect="non-scaling-stroke"></path>
				<path d="M7.5 7.5V5.5C7.5 4.11929 8.61929 3 10 3C11.3807 3 12.5 4.11929 12.5 5.5V7.5" stroke-width="1.4" stroke="#FFFFFF" vector-effect="non-scaling-stroke"></path></svg>
		</div>
	</div>
	<span class="member_info_text">${sessionScope.loginMemberName}님, 반갑습니다</span>
	<div class="main_area">
			        ...
			        <div class="item_img">
			            ...
			            <svg class="product_like 
			                <c:forEach var="likedProduct" items="${likedList}">
			                    ${product.productIdx == likedProduct.productIdx ? 'on' : ''}
			                </c:forEach>" 
